  ...
  try {
    var _loop2 = function _loop2() {
      ...
      if (name === 'EXT-X-VERSION') {
        ...
        playlist.defines || (playlist.defines = []);
...
function parseDateRange(attributes) {
  ...
  var dateRange = new types_1.DateRange({
    id: attributes['ID'],
  ...
  try {
    for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
      ...
      if (name === 'EXT-X-VERSION') {
        ...
        var dateRange = parseDateRange(attributes);
...
function buildMediaPlaylist(lines, playlist, postProcess) {
  ...
  var _iterator9 = _createForOfIteratorHelper(playlist.dateRanges),
    _step9;
  try {
    for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
      var dateRange = _step9.value;
  ...
  var _iterator0 = _createForOfIteratorHelper(playlist.segments.entries()),
    _step0;
  try {
    for (_iterator0.s(); !(_step0 = _iterator0.n()).done;) {
      var _step0$value = _slicedToArray(_step0.value, 2),
        i = _step0$value[0],
        segment = _step0$value[1];
      var base = lines.length;
      var markerType = '';
  ...
  var _iterator1 = _createForOfIteratorHelper(playlist.prefetchSegments),
    _step1;
  try {
    for (_iterator1.s(); !(_step1 = _iterator1.n()).done;) {
      var _segment = _step1.value;
      if (_segment.discontinuity) {
  ...
  var _iterator10 = _createForOfIteratorHelper(playlist.renditionReports),
    _step10;
  try {
    for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
...
function buildDateRange(dateRange) {
  ...
  if (dateRange.cue) {
    attrs.push("CUE=\"".concat(dateRange.cue, "\""));
  }
  if (dateRange.end) {
...
function buildMarkers(lines, markers) {
  var type = '';
  var _iterator11 = _createForOfIteratorHelper(markers),
    _step11;
  try {
    for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
...
function buildDefines(define) {
  var attrs = [];
  for (var attr in define) {
    attrs.push("".concat(attr, "=\"").concat(define[attr], "\""));
  }
  return "#EXT-X-DEFINE:".concat(attrs.join(','));
}
function stringify(playlist, postProcess) {
  ...
  if (playlist.defines) {
    var _iterator13 = _createForOfIteratorHelper(playlist.defines),
      _step13;
    try {
...
var Playlist = /*#__PURE__*/function (_Data2) {
  function Playlist(_ref9) {
    ...
    _defineProperty(_this, "defines", void 0);
...
var MediaPlaylist = /*#__PURE__*/function (_Playlist3) {
  function MediaPlaylist() {
    ...
    _defineProperty(_this3, "dateRanges", void 0);
    ...
    var targetDuration = params.targetDuration,
      ...
      _params$dateRanges = params.dateRanges,
      dateRanges = _params$dateRanges === void 0 ? [] : _params$dateRanges,
